...
Повече информация, както и добри практики, може да намерите в [ръководството ни за Sinatra проекти](https://github.com/fmi/ruby-course-projects/blob/master/web_with_sinatra.md).
...
- Възползвайте се от [GitHub за студенти](https://education.github.com/pack) - имате право на неограничен брой безплатни скрити хранилища.
